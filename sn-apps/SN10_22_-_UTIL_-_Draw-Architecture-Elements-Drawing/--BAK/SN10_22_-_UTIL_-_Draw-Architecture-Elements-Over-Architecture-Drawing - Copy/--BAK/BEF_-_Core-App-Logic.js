...
function updateScale() {
    ...
    SharedState.sliders.maxWidth.max = Math.max(100, Math.floor(currentImageWidthMm));
    SharedState.sliders.maxHeight.max = Math.max(100, Math.floor(currentImageHeightMm));

    // Set default max values if needed
