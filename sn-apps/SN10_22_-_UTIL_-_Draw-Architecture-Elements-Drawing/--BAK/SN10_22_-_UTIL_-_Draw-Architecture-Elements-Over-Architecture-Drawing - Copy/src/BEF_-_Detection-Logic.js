    ...
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            ...
            try {
                ...
                // ----------------------------------------------------------------------------------
                // - Higher scale factor (1.0) makes orthogonalization more effective
                ...
                let orthogonalizedCount  = 0;        // Count of contours attempted for orthogonalization
                let actuallyChangedCount = 0;        // Count of contours actually changed by orthogonalization
...
// FUNCTION |  Unifies nested islands by absorbing smaller contours inside larger ones
// ----------------------------------------------------------------------------------
...
// Helper function: Tests if a point is inside a polygon using the ray casting algorithm
...
// =============================================================================
// STAGE 2: POLYGON REFINEMENT PIPELINE
// ===================================================================================
