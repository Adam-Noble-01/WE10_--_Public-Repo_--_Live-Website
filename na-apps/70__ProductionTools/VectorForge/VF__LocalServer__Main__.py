#!/usr/bin/env python3
# =============================================================================
# NOBLE ARCHITECTURE - VECTORFORGE LOCAL DEVELOPMENT SERVER
# =============================================================================
#
# FILE       : VF__LocalServer__Main__.py
# MODULE     : LocalServer
# AUTHOR     : Adam Noble - Noble Architecture
# PURPOSE    : Entry point for the VectorForge Flask local development server
# CREATED    : 26-Jun-2026
#
# DESCRIPTION:
# - Lean entry point — wires together server modules and starts Flask
# - All server logic is delegated to 10__LocalServer__Modules
# - Opens browser to http://127.0.0.1:8006/ on startup
#
# USAGE:
#   python VF__LocalServer__Main__.py
#   Or use: VF__LocalServer__Main__.bat
#
# -----------------------------------------------------------------------------
#
# DEVELOPMENT LOG:
...
# @delegate: 10__LocalServer__Modules/VF__LocalServer__Config__.py
# @delegate: 10__LocalServer__Modules/VF__LocalServer__AppSetup__.py

from VF__LocalServer__Config__  import HOST, PORT, AUTO_OPEN_BROWSER, BROWSER_DELAY_S  # <-- Server config constants
from VF__LocalServer__AppSetup__ import app, open_browser, print_banner                # <-- Flask app + utilities
