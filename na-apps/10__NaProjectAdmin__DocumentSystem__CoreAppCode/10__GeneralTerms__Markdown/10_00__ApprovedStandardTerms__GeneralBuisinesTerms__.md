...
**"We", "Us", "Our"** refers to Noble Architecture and its representatives.

**"You", "Your", "Client"** refers to the person or entity commissioning the services.

**"Services"** refers to the architectural and design services described in the quotation.

**"Project"** refers to the specific work detailed in the quotation and any subsequent variations.

**"Deliverables"** refers to drawings, documents, reports, and other materials produced as part of the Services.
...
- Ensure access to the site as reasonably required
- Notify us promptly of any changes affecting the project
...
Additional work outside the original scope will be charged at our standard hourly rates or as agreed in writing.
...
- You are granted a licence to use the Deliverables for the specific project only
- The Deliverables may not be used for other projects without written consent
- We retain the right to use images of the completed project for marketing purposes
- Original design concepts and methodologies remain our intellectual property
...
We shall not be liable for delays caused by factors outside our reasonable control.
...
- We cannot guarantee that approvals will be granted
- Planning and building control fees are payable by the Client separately
- Amendments required by authorities may incur additional design fees
...
- Matters outside the agreed scope of services
- Advice or work provided by other consultants

We maintain professional indemnity insurance appropriate to the nature and scale of our work.
...
- By giving 14 days written notice
- Immediately if the other party is in material breach

Upon termination, the Client shall pay for all work completed to date and any committed expenses. Copyright in partially completed work shall transfer upon payment.
...
- Failure to enforce any provision does not constitute a waiver of the right to do so
- Neither party may assign their rights under this agreement without written consent
...
- You have read and understood all terms and conditions contained herein
- You have the authority to enter into this agreement
- A record of your signature including timestamp and verification details will be retained
