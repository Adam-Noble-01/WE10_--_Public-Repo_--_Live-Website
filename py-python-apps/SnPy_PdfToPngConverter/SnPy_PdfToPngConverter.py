...
# Import the icon loader utility from the sibling dependency directory
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../SnPY_CommonDependencyFiles')))
from SnPy_Core_Utils_IconLoaderAndHandling import set_window_icon
...
class PdfToPngConverter:
    ...
    def convert_pdf_to_png(self, pdf_path):
        """Convert a PDF file to a high-quality PNG image using PyMuPDF."""
        try:
            import fitz  # PyMuPDF
            ...
            output_name = pdf_name.rsplit('.', 1)[0] + "_-_Converted_From_PDF.png"
            ...
            # Render at high DPI for quality (e.g., 300)
